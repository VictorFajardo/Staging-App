window.onload = function() {
	...
	var t2d = document.getElementById("text2d");
	...
	TweenLite.to(t1a, .5, {x: 160, y: -25, ease: Back.easeOut.config(1.4)});
	TweenLite.to(t1b, .5, {x: 160, y: -25, delay: .2, ease: Back.easeOut.config(1.4)});
	TweenLite.to(t1c, .5, {x: 160, y: -25, delay: .4, ease: Back.easeOut.config(1.4)});
	TweenLite.to(t1d, .5, {x: 160, y: -25, delay: .6, ease: Back.easeOut.config(1.4)});

	TweenLite.to(t1a, .5, {x: 320, y: -50, delay: 2.1, ease: Back.easeIn.config(1.4)});
	TweenLite.to(t1b, .5, {x: 320, y: -50, delay: 2.3, ease: Back.easeIn.config(1.4)});
	TweenLite.to(t1c, .5, {x: 320, y: -50, delay: 2.5, ease: Back.easeIn.config(1.4)});
	TweenLite.to(t1d, .5, {x: 320, y: -50, delay: 2.7, ease: Back.easeIn.config(1.4)});

	TweenLite.to(bg2, .5, {opacity: 1, delay: 3.2, ease: Power1.easeIn});
	TweenLite.to(t2a, .5, {x: 160, y: -25, delay: 3.2, ease: Back.easeOut.config(1.4)});
	TweenLite.to(t2b, .5, {x: 160, y: -25, delay: 3.4, ease: Back.easeOut.config(1.4)});
	TweenLite.to(t2c, .5, {x: 160, y: -25, delay: 3.6, ease: Back.easeOut.config(1.4)});
	TweenLite.to(t2d, .5, {x: 160, y: -25, delay: 3.8, ease: Back.easeOut.config(1.4)});

	TweenLite.to(t2a, .5, {x: 320, y: -50, delay: 5.1, ease: Back.easeIn.config(1.4)});
	TweenLite.to(t2b, .5, {x: 320, y: -50, delay: 5.3, ease: Back.easeIn.config(1.4)});
	TweenLite.to(t2c, .5, {x: 320, y: -50, delay: 5.5, ease: Back.easeIn.config(1.4)});
	TweenLite.to(t2d, .5, {x: 320, y: -50, delay: 5.7, ease: Back.easeIn.config(1.4)});

	TweenLite.to(t3, .5, {x: 160, y: -25, delay: 6, ease: Back.easeOut.config(1.4)});
	TweenLite.to(clickarea, .5, {height: 309, delay: 6, ease: Power1.easeIn});
	TweenLite.to(scroll, .5, {y: -289, delay: 6, ease: Power1.easeIn});

	TweenLite.to(bg2, .5, {opacity: 0, delay: 6.5});
	TweenLite.to(bg3, .5, {opacity: 1, delay: 6.5, ease: Power1.easeIn});

	TweenLite.to(t3, .5, {x: 320, y: -50, delay: 9.5, ease: Back.easeIn.config(1.4)});

	TweenLite.to(t4, .5, {x: 160, y: -25, delay: 10, ease: Back.easeOut.config(1.4)});

	TweenLite.to(t4, .5, {x: 320, y: -50, delay: 13.5, ease: Back.easeIn.config(1.4)});
