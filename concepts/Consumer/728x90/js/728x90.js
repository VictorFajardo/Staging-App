window.onload = function() {
	...
	TweenLite.to(t1a, .5, {x: 200, opacity: 1, ease: Back.easeOut.config(1.4)});
	TweenLite.to(t1b, .5, {x: 200, opacity: 1, delay: .2, ease: Back.easeOut.config(1.4)});

	TweenLite.to(t1a, .5, {x: 400, opacity: 0, delay: 2.1, ease: Back.easeIn.config(1.4)});
	TweenLite.to(t1b, .5, {x: 400, opacity: 0, delay: 2.3, ease: Back.easeIn.config(1.4)});

	TweenLite.to(bg1, .5, {opacity: 0, delay: 3.2});
	TweenLite.to(bg2, .5, {opacity: 1, delay: 3.2, ease: Power1.easeIn});
	TweenLite.to(t2a, .5, {x: 200, opacity: 1, delay: 3.2, ease: Back.easeOut.config(1.4)});
	TweenLite.to(t2b, .5, {x: 200, opacity: 1, delay: 3.4, ease: Back.easeOut.config(1.4)});

	TweenLite.to(t2a, .5, {x: 400, opacity: 0, delay: 5.1, ease: Back.easeIn.config(1.4)});
	TweenLite.to(t2b, .5, {x: 400, opacity: 0, delay: 5.3, ease: Back.easeIn.config(1.4)});

	TweenLite.to(t3, .5, {x: 200, opacity: 1, delay: 6, ease: Back.easeOut.config(1.4)});
	TweenLite.to(clickarea, .5, {width: 358, delay: 6, ease: Power1.easeIn});
	TweenLite.to(scroll, .5, {x: -368, delay: 6, ease: Power1.easeIn});

	TweenLite.to(bg2, .5, {opacity: 0, delay: 6.5});
	TweenLite.to(bg3, .5, {opacity: 1, delay: 6.5, ease: Power1.easeIn});

	TweenLite.to(t3, .5, {x: 400, opacity: 0, delay: 9.5, ease: Back.easeIn.config(1.4)});

	TweenLite.to(t4, .5, {x: 200, opacity: 1, delay: 10, ease: Back.easeOut.config(1.4)});

	TweenLite.to(t4, .5, {x: 400, opacity: 0, delay: 13.5, ease: Back.easeIn.config(1.4)});
	
	TweenLite.to(bg3, .5, {opacity: 0, delay: 14});
	TweenLite.to(bg4, .5, {opacity: 1, delay: 14, ease: Power1.easeIn});
	TweenLite.to(logo, .5, {opacity: 1, delay: 14, ease: Power1.easeIn});
